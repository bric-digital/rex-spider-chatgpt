  ...
  async validateIdentifier(identifier, endpoint = null) {
    return new Promise((resolve, reject) => {
      globalThis.chrome.runtime.sendMessage({
        ...
        globalThis.chrome.runtime.sendMessage({ "messageType": "fetchConfigurationScope" }).then((scopeResponse) => scopeResponse ?? {}).catch(() => ({})).then((configurationScope) => {
          const configUrl = scopeConfigurationUrl(resolvedEndpoint, configurationScope, globalThis.chrome.runtime.getURL("/"));
